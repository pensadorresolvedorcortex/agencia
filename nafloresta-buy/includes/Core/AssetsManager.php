...
class AssetsManager
{
    ...
    public function enqueueFront(): void
    {
        ...
        wp_localize_script('nafb-front-app', 'nafbApp', [
            ...
            'summaryNonce' => wp_create_nonce('nafb_get_cart_summary'),
            'mode' => 'matrix',
            'trackNonce' => wp_create_nonce('nafb_track_event'),
            'cartUrl' => wc_get_cart_url(),
            'checkoutUrl' => wc_get_checkout_url(),
            'debugSubtotal' => (defined('WP_DEBUG') && WP_DEBUG) || (isset($_GET['nafb_debug_subtotal']) && (string) $_GET['nafb_debug_subtotal'] === '1'),
            'texts' => [
