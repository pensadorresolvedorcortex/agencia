...
foreach ([
    ...
    'Confirme seu Acesso', 'logo-1.png', 'Grupos WhatsApp - Todos os Direitos Reservados', 'background:#eaeaea',
...
foreach (['.pgw-auth--otp', '.pgw-otp-logo', '.pgw-otp-code input', '.pgw-otp-actions', 'grid-template-columns:1.2fr .8fr'] as $rule) if (strpos($css, $rule) === false) throw new RuntimeException('Missing OTP CSS contract: ' . $rule);
