...
foreach ([['confirmation'=>'diferente'],['terms'=>0],['privacy'=>0],['email'=>'invalid'],['phone'=>'123']] as $change) if ($policy->normalize(array_replace($base,$change))['valid']) throw new RuntimeException('Invalid registration accepted');
...
echo "7 registration policy cases passed.\n";
