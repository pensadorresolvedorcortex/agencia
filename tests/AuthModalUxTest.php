...
$phpRules=['render_global_auth_modal', 'pgw-open-auth,.pgw-open-login,.pgw-open-register', "self::auth_modal('login','<p role=\"status\">Entre ou cadastre-se para visualizar seus grupos.</p>'", 'pgw_pending_redirect', 'register_data', 'register_rate', 'register_proof', "'registration',null,true", 'placeholder="Categoria"', "in_array('pgw_pending_member'"];
...
echo "16 authentication and frontend UX checks passed.\n";
