...
final class Plugin {
    ...
    private static function otp_email_html(string $code, string $purpose): string {
        ...
        $logo = 'https://www.portalgruposwhatsapp.com.br/wp-content/uploads/2026/03/logo-1.png';
