...
final class Plugin {
    ...
    public static function account_header(): string { if(!is_user_logged_in())return '<details class="pgw-account-menu pgw-account-menu--guest"><summary>Entrar <span>/</span> Cadastrar</summary><nav><a class="pgw-open-login" href="'.esc_url(home_url('/entrar/')).'">Entrar</a><a class="pgw-open-register" href="'.esc_url(home_url('/criar-conta/')).'">Criar conta</a><a href="'.esc_url(home_url('/recuperar-senha/')).'">Recuperar senha</a></nav></details>';$user=wp_get_current_user();$account=home_url('/minha-conta/');return '<details class="pgw-account-menu"><summary>'.self::avatar_html($user->ID,40,'pgw-account-menu__avatar').'<span><small>Minha conta</small>'.esc_html($user->display_name).'</span></summary><nav><a href="'.esc_url($account).'#pgw-profile">Perfil e nome</a><a href="'.esc_url($account).'#pgw-avatar">Foto do perfil</a><a href="'.esc_url(home_url('/meus-grupos/')).'">Meus grupos</a><a href="'.esc_url(home_url('/enviar-grupo/')).'">Enviar grupo</a><a href="'.esc_url($account).'#pgw-password">Senha e segurança</a><a href="'.esc_url($account).'#pgw-email">Alterar e-mail</a><a href="'.esc_url($account).'#pgw-sessions">Sessões ativas</a><a href="'.esc_url($account).'#pgw-export">Exportar dados</a><a class="pgw-account-menu__logout" href="'.esc_url(wp_logout_url(home_url('/'))).'">Sair</a></nav></details>'; }
