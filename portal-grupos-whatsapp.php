...
final class Plugin {
    ...
    private static function public_query_args(array $extra=[]): array { return array_merge(['post_type'=>self::CPT,'post_status'=>'publish','posts_per_page'=>30,'meta_query'=>[(new Search\PublicStatusPolicy())->metaQuery()], 'orderby'=>['date'=>'DESC','ID'=>'DESC']], $extra); }
