...
final class Plugin {
    ...
    public static function login_form(array $atts=[]): string {
        ...
        $error=sanitize_key((string)($_GET['pgw_auth_error']??''));$message=$error?'<p role="alert">Não foi possível entrar. Confira os dados ou tente novamente em instantes.</p>':'';
