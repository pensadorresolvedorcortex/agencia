                  ...
                  <div class="card-widget">
                      ...
                      <div class="card">
                        ...
                        <div class="delete-profile">
                            <img src="<?php echo esc_url(get_template_directory_uri()); ?>/images/dashboard/triangle.png" class="img-fluid">
                            <p class="text-muted">
                            <?php 
							...
							<?php
								if(is_array($selected_custom_data) && !empty($selected_custom_data))
								{
									if ($pid != '' && class_exists('ACF')) {
										...
										echo exertio_returnEcho($custom_fields_html);
									}
								}
							 ?>
							</div>
                  ...
                  <?php 
					...
					?>
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-6">
                              <label><?php echo esc_html__('Contact Email','exertio_theme'); ?></label>
                              <input type="email" class="form-control" name="rma_contact_email" value="<?php echo esc_attr(sanitize_email((string) get_post_meta($pid, 'email_contato', true))); ?>" placeholder="contato@entidade.org.br">
                              <p><?php echo esc_html__('Public contact e-mail (different from login e-mail).','exertio_theme'); ?></p>
                            </div>
                            <div class="form-group col-md-6">
