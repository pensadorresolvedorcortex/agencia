...
if (!class_exists('ElfsightAgeVerificationPlugin')) {
    class ElfsightAgeVerificationPlugin {
        private $name;
        private $slug;
        private $version;
        private $textDomain;
        ...
        public function __construct($config) {
            ...
            $this->update = new ElfsightAgeVerificationPluginUpdate($this->updateUrl, $this->version, $this->pluginSlug, $this->purchaseCode);
            $this->widgetsApi = new ElfsightAgeVerificationWidgetsApi($this->slug, $this->pluginFile, $this->textDomain);
            $this->admin = new ElfsightAgeVerificationPluginAdmin($config, $this->widgetsApi);
            $this->widget = new ElfsightAgeVerificationWidget($config, $this->widgetsApi);
            $this->vcElement = new ElfsightAgeVerificationVCElement($config, $this->widgetsApi);
