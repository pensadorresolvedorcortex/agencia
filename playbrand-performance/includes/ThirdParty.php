...
final class ThirdParty {
 ...
 public static function guard(): void {
  ...
  echo '<script id="pbpf-third-party">(function(){var ok=false;var allow=function(){ok=true;window.dispatchEvent(new Event("pbpf:interaction"));};["click","touchstart","keydown"].forEach(function(e){addEventListener(e,allow,{once:true,passive:true});});var isTarget=function(u){try{var x=new URL(u,location.href);return x.hostname==="ipinfo.io"&&x.pathname==="/json";}catch(e){return false;}};var f=window.fetch;if(f)window.fetch=function(i){var u=String(i&&i.url||i);if(!ok&&isTarget(u))return Promise.reject(new Error("PlayBrand third-party gate"));return f.apply(this,arguments)};var o=XMLHttpRequest.prototype.open;XMLHttpRequest.prototype.open=function(m,u){if(!ok&&isTarget(String(u))){this.__pbpfBlocked=true;return o.call(this,m,"data:application/json,%7B%7D",true)}return o.apply(this,arguments)};})();</script>';
 }
}
