...
O shortcode `[pgw_categorias limit="10" show_more="1"]` apresenta dez categorias inicialmente e um controle compacto para revelar as demais. Cada categoria recebe uma cor neon distinta e legível. Para personalizar, acesse **Portal Grupos → Categorias**, adicione ou edite uma categoria e escolha sua cor no campo **Cor da categoria**. A mesma cor identifica a categoria sobre a imagem dos cards.
