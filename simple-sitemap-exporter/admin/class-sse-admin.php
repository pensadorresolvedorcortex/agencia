...
class SSE_Admin
{
    ...
    public function __construct($scanner, $sitemap, $storage)
    {
        ...
        add_action('admin_init', array($this, 'maybe_disable_page_cache'));
    ...
    public function maybe_disable_page_cache()
    {
        ...
        if ('simple-sitemap-exporter' !== $page) {
            return;
        }
    ...
    public function render_page()
    {
        ...
        if (count($urls) > $this->sitemap->get_max_urls()) {
            // Força exibição de 6 botões para ambientes que ainda têm partes antigas em cache/storage.
            for ($i = 1; $i <= 6; $i++) {
        ...
        <div class="wrap">
            ...
            <?php if (count($urls) > $this->sitemap->get_max_urls()) : ?>
                <div class="notice notice-info inline">
                    <p><?php echo esc_html__('Para garantir 6 partes atualizadas, clique em "Gerar sitemap.xml" após finalizar o escaneamento.', 'simple-sitemap-exporter'); ?></p>
                </div>
            <?php endif; ?>
                ...
                fetch(ajaxurl, { method: 'POST', credentials: 'same-origin', body: form })
                    ...
                    .then(function(payload){
                        ...
                        if (data.done) {
                            ...
                            u.searchParams.set('_sse_bust', String(Date.now()));
