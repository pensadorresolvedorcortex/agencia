Blog Privilège AI Premium Final v4.4.0
...
Alterações v4.3.2 — compatibilidade com Yoast moderno:
- Reconstrói o `Indexable` de cada artigo depois de salvar os metadados SEO; versões atuais do Yoast podem alimentar as colunas administrativas pela tabela de indexables, e não somente pelo `postmeta`.
- Mantém fallback compatível quando o Yoast ou o construtor de indexables não estiver disponível.
