...
delete_option('bpv_yoast_score_migration_v431');
delete_option('bpv_yoast_score_migration_v432');
delete_option('bpv_yoast_score_migration_v440');
delete_option('bpv_yoast_score_migration_v441');
