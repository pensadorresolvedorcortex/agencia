...
wp_clear_scheduled_hook('bpv_blog_privilege_trash_numbered_posts');
...
delete_option('bpv_blog_privilege_slug_hashes');
...
delete_option('bpv_blog_privilege_numbered_purge_status');
