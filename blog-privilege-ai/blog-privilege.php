...
final class BPV_Blog_Privilege {
    ...
    public static function render_admin_page() {
        ...
        .bpv-saas{background:radial-gradient(circle at 8% 0%,rgba(14,165,233,.18),transparent 30%),radial-gradient(circle at 94% 10%,rgba(168,85,247,.16),transparent 28%),linear-gradient(135deg,rgba(255,255,255,.96),rgba(241,245,249,.86))!important;color:#0f172a!important;font-family:"Maven Pro",Inter,system-ui,sans-serif!important;font-weight:800!important}.bpv-hero,.bpv-card{background:rgba(255,255,255,.64)!important;border:1px solid rgba(148,163,184,.28)!important;box-shadow:0 18px 58px rgba(15,23,42,.12),inset 0 1px 0 rgba(255,255,255,.85)!important}.bpv-title,.bpv-card h2,.bpv-metric strong{color:#0f172a!important}.bpv-sub,.bpv-table td,.bpv-art-card p{color:#334155!important}.bpv-table th{color:#2563eb!important}.bpv-kicker{color:#0891b2!important}.bpv-grid{grid-template-columns:repeat(5,minmax(110px,1fr))!important}.bpv-metric:nth-child(1){background:linear-gradient(135deg,rgba(34,197,94,.26),rgba(255,255,255,.72))!important}.bpv-metric:nth-child(2){background:linear-gradient(135deg,rgba(14,165,233,.26),rgba(255,255,255,.72))!important}.bpv-metric:nth-child(3){background:linear-gradient(135deg,rgba(168,85,247,.24),rgba(255,255,255,.72))!important}.bpv-metric:nth-child(4){background:linear-gradient(135deg,rgba(249,115,22,.22),rgba(255,255,255,.72))!important}.bpv-metric:nth-child(5){background:linear-gradient(135deg,rgba(236,72,153,.20),rgba(255,255,255,.72))!important}.bpv-preview{min-height:210px;border-radius:26px;background:linear-gradient(135deg,rgba(226,232,240,.72),rgba(255,255,255,.9));border:1px solid rgba(148,163,184,.32);position:relative;overflow:hidden;box-shadow:0 18px 50px rgba(15,23,42,.16)}.bpv-preview img{width:100%;height:100%;min-height:210px;object-fit:cover;display:block}.bpv-preview span{position:absolute;left:16px;bottom:14px;background:rgba(15,23,42,.72);color:#fff;border-radius:999px;padding:7px 12px;font-size:11px;letter-spacing:.08em;text-transform:uppercase}.bpv-preview-empty{display:flex;align-items:center;justify-content:center;color:#64748b;font-size:13px;text-align:center;padding:24px}.bpv-saas{min-height:auto!important;padding:18px!important;border-radius:24px!important}.bpv-shell{max-width:1120px!important}.bpv-hero{padding:18px!important;margin-bottom:12px!important;grid-template-columns:1.25fr .75fr!important}.bpv-title{font-size:28px!important;margin:6px 0 8px!important}.bpv-sub{font-size:13px!important;line-height:1.45!important}.bpv-preview,.bpv-preview img{min-height:145px!important;height:145px!important}.bpv-grid{gap:10px!important;margin-bottom:10px!important}.bpv-metric{padding:12px 14px!important;border-radius:18px!important}.bpv-metric span{font-size:10px!important}.bpv-metric strong{font-size:16px!important;margin-top:4px!important}.bpv-card{padding:14px 16px!important;margin-top:10px!important;border-radius:20px!important}.bpv-card h2{font-size:16px!important;margin-bottom:8px!important}.bpv-table{border-spacing:0 5px!important}.bpv-table th{width:170px!important}.bpv-actions{margin-top:10px!important}.bpv-saas .button{min-height:30px!important;padding:2px 12px!important}
        ...
        echo '<section class="bpv-hero"><div><div class="bpv-kicker">Blog Privilège AI • Premium SaaS 2026</div><h1 class="bpv-title">Centro editorial autônomo com fotografia real e SEO limpo</h1><p class="bpv-sub">Dashboard branco glassmorphism ultra para operar geração automática, publicação WordPress, diagnóstico por etapa e direção de arte fotográfica premium sem fallback ilustrativo.</p></div><div class="bpv-preview">' . ($last_image_url ? '<img src="' . esc_url($last_image_url) . '" alt="Última imagem destacada gerada"><span>Última imagem</span>' : '<div class="bpv-preview-empty">A última imagem destacada aparecerá aqui após a próxima geração bem-sucedida.</div>') . '</div></section>';
